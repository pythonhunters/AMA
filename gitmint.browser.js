...
([
  ...
  (function(module, exports, __webpack_require__) {
    ...
    function render(state, instance) {
      ...
      var parts = (!instance.above) ? ['renderHeader', 'renderComments', 'renderEditor', 'renderFooter'] : ['renderHeader', 'renderEditor', 'renderFooter', 'renderComments'];
      ...
      _createClass(Gitment, [{
        ...
        value: function post(body) {
          ...
          return this.getIssue().then(function(issue) {
            ...
            return _utils.http.post(matched[3], {
              body: body
            }, matched[1] || undefined);
          }).then(function(data) {
        ...
        value: function loadComments() {
          ...
          return this.getIssue().then(function(issue) {
            var matched = issue.comments_url.match(rx_url_with_protocol);
            return _utils.http.get(matched[3], {
              page: page,
